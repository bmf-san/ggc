...
// testMockGitClient is a minimal mock git client for config package testing
type testMockGitClient struct {
	version    string
	commitHash string
}

// Only implement the methods needed by config package
func (m *testMockGitClient) GetVersion() (string, error)    { return m.version, nil }
func (m *testMockGitClient) GetCommitHash() (string, error) { return m.commitHash, nil }

// Stub implementations for all other required methods
func (m *testMockGitClient) GetCurrentBranch() (string, error)     { return "main", nil }
func (m *testMockGitClient) GetBranchName() (string, error)        { return "main", nil }
func (m *testMockGitClient) GetGitStatus() (string, error)         { return "", nil }
...
func (m *testMockGitClient) GetAheadBehindCount(_, _ string) (string, error) { return "0\t0", nil }
