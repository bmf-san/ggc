...
const commandsReferencePath = "docs/content/guide/commands.md"
...
func writeCommandsReference(path string) error {
	...
	b.WriteString("---\n")
	b.WriteString("title: \"Commands\"\n")
	b.WriteString("description: \"Complete reference of every ggc command and its arguments.\"\n")
	b.WriteString("slug: \"commands\"\n")
...
// categoryAnchor returns the anchor for a category heading, matching the
// heading IDs that gohan's goldmark renderer auto-generates from the heading
// text (lower-cased, non-alphanumeric runs collapsed to a single hyphen).
